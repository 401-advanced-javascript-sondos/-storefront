...
import { getOnePro, deleteProduct } from '../store/rtk/products';
...
const ProductDetail = (props) => {
  ...
  const disabled = currentProduct.inStock == 0;

  const classes = useStyles();

  useEffect(() => {
    getOnePro(id);
  }, [getOnePro, id, products]);
  ...
  return (
    <Container maxWidth='sm' className={classes.container}>
      ...
      <Card className='card'>
        <img src={currentProduct.img} className={classes.imgStyle} />
